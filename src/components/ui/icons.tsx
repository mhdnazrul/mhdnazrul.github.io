...
// All SVG icons used across the portfolio are defined here ONCE.
// Import from '@/components/ui/icons' in any component.
// ============================================================================
...
export const CodeforcesIcon = ({ size = 24, className = '' }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const LeetCodeIcon = ({ size = 24, className = '' }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const AtCoderIcon = ({ size = 24, className = '' }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const CodeChefIcon = ({ size = 24, className = '' }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
// ============================================================================
// Icon-to-ID Mapping
// Used by components that render social links from profile.socials data.
// The keys here match the `id` field in profile.socials[].
// ============================================================================

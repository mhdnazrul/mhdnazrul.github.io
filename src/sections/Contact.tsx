                                        ...
                                        ({ id, label, value, href }) => {
                                            ...
                                            return (
                                                <a
                                                    ...
                                                    aria-label={label}
                                                    className="flex items-center gap-3 text-[var(--text-secondary)] text-sm font-mono hover:text-[var(--primary)] transition-colors group"
                                                >
                                                    {Icon && (
                                                        <Icon
                                                            size={15}
                                        ...
                                        ({ id, label, href }) => {
                                            ...
                                            return (
                                                <a
                                                    ...
                                                    rel="noopener noreferrer"
                                                    aria-label={label}
                                                    className="text-[var(--text-muted)] hover:text-[var(--primary)] transition-colors hover:-translate-y-0.5"
                                                >
                                                    {Icon && <Icon size={20} />}
                                                </a>
                                            );
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[var(--bg-input)] border border-[var(--border-medium)] px-4 py-3 text-[var(--text-primary)] text-sm font-mono placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--primary)] transition-colors duration-200 disabled:opacity-50"
                                        aria-required="true"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        disabled={status === 'loading'}
                                        className="w-full bg-[var(--bg-input)] border border-[var(--border-medium)] px-4 py-3 text-[var(--text-primary)] text-sm font-mono placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--primary)] transition-colors duration-200 disabled:opacity-50 resize-none"
                                        aria-required="true"
                                    />
                                </div>
                                ...
                                {status === 'success' && (
                                    <motion.div
                                        ...
                                        className="px-4 py-3 bg-green-500/10 border border-green-500/30 text-green-500 text-xs font-mono"
                                    >
                                ...
                                <motion.button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 py-3 bg-[var(--primary)] text-white font-mono text-sm font-semibold hover:bg-[var(--primary)]/90 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
